...
public class MobileManagementPanel extends JPanel {
    ...
    ImageIcon icon = new ImageIcon(getClass().getResource("/cart2.png"));
    ...
    private void displayMobileDetails() {
        ...
        JLabel logoLabel;
        try {
            ImageIcon logoIcon = new ImageIcon("/login.png"); // Replace with your logo path or resource
